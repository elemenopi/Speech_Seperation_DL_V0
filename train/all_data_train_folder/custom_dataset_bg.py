...
#
    ...
    def get_mixture_and_gt(self, metadata, curr_dir, target_angle,
        ...
        voice_positions = []
        for key in metadata.keys():
            voice_positions.append(metadata[key]['Position'])
            num_speakers +=1
        draw_diagram(voice_positions, [target_angle], curr_window_size, f"vis_speakers_{num_speakers}_window_{curr_window_size}.png")
        #end visualize
