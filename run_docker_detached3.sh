...
docker run --gpus all -d \
  ...
  --name "${USER}_test_detached_partition3" \
  audio-db python /app/generate_data.py --output_dir_train /app/gannot-lab-UG/ilya_tomer/OUTPUTS/OUTPUTS_BASIC_TRAIN/partition3
